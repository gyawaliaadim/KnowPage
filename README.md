...
Service Tech Port Frontend Next.js 3000 Backend API FastAPI 8000 ML Service FastAPI + Uvicorn 8001
🚀 Getting Started
Prerequisites
...
All three services need to be running simultaneously. Once up, open http://localhost:3000 in your browser.
🔄 Request Flow
